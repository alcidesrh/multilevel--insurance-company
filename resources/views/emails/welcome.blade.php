...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; ">
    ...
    <center role="article" aria-roledescription="email" lang="en" style="width: 100%;">
        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="750"
            ...
            <tr>
                <td
                    ...
                    <div style="max-width: 550px; margin: auto; font-family: 'Montserrat', system, 'Verdana', sans-serif;">
                      Usted a sido añadido como un {{ $user->role->slug == 'broker'?'Representative':($user->role == 'elite'?'Elite Representative':ucfirst($user->role))}} en {{$user->company->name ?? ''}}.
                    </div>
                </td>
            </tr>
            ...
            <tr>
              <td style="padding:10px 0 30px 0;text-align: center; margin: auto; font-family: 'Montserrat', system, 'Verdana', sans-serif; color: #FFFFFF;font-size: 16px;">
                <center>
                <a href="{{config('app.url')}}/token/{{$token}}" style="display: inline-block; padding: 11px 30px; margin: 20px 0px 30px; font-weight: 600; color: #fff; background: #00c0c8; border-radius: 60px; text-decoration:none;">Activar cuenta</a>
                </center>
              </td>
            </tr>
