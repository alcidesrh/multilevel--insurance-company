        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="750"
            ...
            <tr>
                <td
                    ...
                    Hola {{isset($newUser) ? $newUser->first_name.',' : ''}}
                </td>
            </tr>
            <tr>
                <td
            ...
            <tr>
              <td style="padding:10px 0 30px 0;text-align: center; margin: auto; font-family: 'Montserrat', system, 'Verdana', sans-serif; color: #FFFFFF;font-size: 16px;">
                <center>
                <a href="{{config('app.url')}}/application?number={{$user->number_account}}" style="display: inline-block; padding: 11px 30px; margin: 20px 0px 30px; font-weight: 600; color: #fff; background: #00c0c8; border-radius: 60px; text-decoration:none;">Llenar Aplicación</a>
                </center>
              </td>
            </tr>
