...
class UserEditResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'children' => $this->children ? new GenericResourceCollection($this->children, ['id', 'name', ['image' => ['id', 'url']]]) : null,
            'parent' => $this->parent ? new GenericResource($this->parent, ['id', 'name', ['image' => ['id', 'url']]]) : null,
